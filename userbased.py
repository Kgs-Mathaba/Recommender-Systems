...
if (
    not os.path.exists("user2movie.json")
    or not os.path.exists("movie2user.json")
    or not os.path.exists("usermovie2rating.json")
    or not os.path.exists("usermovie2rating_test.json")
):
